...
- [Queuing, retry, timeout, and resource to telemetry conversion settings](https://github.com/open-telemetry/opentelemetry-collector/blob/main/exporter/exporterhelper/README.md)
